...
class H1_2(LeggedManipulatorModel):
    ...
    def __init__(self, idn=0):
        super().__init__(xml_path_completion("robots/h1_2/robot.xml"), idn=idn)
    ...
    @property
    def default_controller_config(self): # * BBMARK
        """
